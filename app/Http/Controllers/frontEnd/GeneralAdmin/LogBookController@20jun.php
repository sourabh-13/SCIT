...
class LogBookController extends GeneralAdminController
{
    ...
    {   
        ...
        /*else {
            $log_book_records = $log_book_records->where('log_book.date','>',$today);
            //$add_new_case = '';
        }*/


        $log_book_records  = $log_book_records->orderBy('log_book.id','desc')
        ...
        foreach ($log_book_records as $key => $value) {
            ...
            //$created_date = date('d F Y h:i a', strtotime($value->created_at));
                              ...
                              echo '<input type="hidden" name="edit_su_record_id[]" value="'.$value->id.'" disabled="disabled" class="edit_record_id_'.$value->id.'" />
                                ...
                                <div class="pop-notifbox">
                                    <ul class="pop-notification" type="none">';
                                        ...
                                        echo'<a href="'.url('/general/logbook/calendar/add?log_book_id='.$value->id).'" log_book_id="'.$value->id.'" class="add_to_clndr"> <span class="color-green"> <i class="fa fa-plus-circle"></i> </span> Add to Calendar</a> </li>'; 
                                        //}
                                    echo '</ul>
                                </div>
                            </span>
