...
{   
    ...
    public function index($manager_id) {
        ...
        foreach ($sm_sick_form as $key => $value) {
            ...
            echo '  <div class="col-md-12 col-sm-12 col-xs-12 cog-panel remove-my-sick-rec-row">
                                ...
                                <div class="input-group popovr">
                                    ...
                                    <span class="input-group-addon cus-inpt-grp-addon clr-blue settings">
                                        ...
                                        <div class="pop-notifbox">
                                            ...
                                            <li> <a href="#" sm_sick_leave_id='.$value->id.' data-dismiss="modal" aria-hidden="true" class="view-my-sick-leave-content"> <span> <i class="fa fa-eye"></i> </span> View </a> </li>
                                        <!-- <li> <a href="#" class="delete_my_sick_record" sm_sick_leave_id='.$value->id.'> <span class="color-red"> <i class="fa fa-exclamation-circle"></i> </span> Remove </a> </li> -->
                                            <li> <a href="'.url('/system/calendar').'">  <span class="color-green"> <i class="fa fa-plus-circle"></i> </span> Add to calendar </a>
                                            </li>
                                            </ul>
                                        </div>
                                    </span>
        ...
        foreach ($sick_record as $key => $value) {
            ...
            echo '<div class="col-md-12 col-sm-12 col-xs-12 cog-panel">
                ...
                <div class="modal-footer m-t-0 m-b-15 modal-bttm">
                    ...
                    <button class="btn btn-warning" type="submit" data-toggle="modal" data-dismiss="modal" data-target="#mySickLeaveModal"> Confirm </button>
                </div>';
        } 
        die;
        /*<div class="col-md-12 col-sm-12 col-xs-12 cog-panel">
