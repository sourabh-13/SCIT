...
$html =<<<EOD
        ...
        <table style="width:100%; font-size:14pt;background:#fff;border:1px solid #ddd;" cellpadding="15" cellspacing="0">
            <tbody>
                <tr>
                    <td style="text-align:center; color:#1F88B5;font-weight:bolder;border:none;">Staff Rota </td>
                </tr>
            </tbody>
        </table>

        <table style="width:100%; font-size:11pt; background:#fff;border:1px solid #ddd;" cellpadding="10" cellspacing="0">
            <tbody>
                <tr>
                    <td> <span style="color:#767676;font-weight:bolder;">Duration :</span> <span style="font-size:10pt; font-weight:lighter;color:#767676;">{$range_startdate} to {$range_enddate}</span> </td>
                    <td style="text-align:right;"> <span style="color:#767676;font-weight:bolder;">Access Level :</span> <span style="font-size:10pt; font-weight:lighter;color:#767676;">{$access_level_name}</span> </td>
                </tr>
            </tbody>
        </table>
        <table style="width:100%; font-size:8pt; background:#fff;border:1px solid #ddd;" cellpadding="4" cellspacing="0">
