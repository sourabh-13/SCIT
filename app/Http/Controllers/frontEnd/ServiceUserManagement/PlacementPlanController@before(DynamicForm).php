...
use DB,Auth;
use App\ServiceUserPlacementPlan, App\Notification, App\FormBuilder, App\ServiceUser, App\HomeLabel;
...
class PlacementPlanController extends ServiceUserManagementController
{
    ...
    public function view_target(Request $request, $active_target_id=null) {
        ...
        $active_target = ServiceUserPlacementPlan::where('id',$active_target_id)->first();
    ...
    public function edit(Request $request) { 
        ...
        if($request->isMethod('post'))  {
            ...
            if($date < $today)  {
                ...
                $placement_plan->formdata        = $formdata;
