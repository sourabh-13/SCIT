...
<?php
    if(isset($rota_shift)) {
        ...
        $action = url('admin/home/rota-shift/edit'.$rota_shift->id);
        $task = "Edit";
                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" name="name" class="form-control" disabled placeholder="Name" value="{{ $shift_plan->name }}" maxlength="255">
                                </div>
                            </div>
							...
							<div class="form-actions">
								<div class="row">
									<div class="col-lg-offset-2 col-lg-10">
                                        <input type="hidden" name="shift_type_id" value="{{ $shift_type_query->type_id }}">
										<input type="hidden" name="_token" value="{{ csrf_token() }}">
										<input type="hidden" name="shift_id" value="{{ (isset($shift_plan->id)) ? $shift_plan->id : '' }}">
