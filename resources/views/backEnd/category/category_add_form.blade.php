                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            <form class="form-horizontal" role="form" method="post" action="{{ url('admin/categories/add') }}" id="category_form" enctype="multipart/form-data">

                            <div class="form-group">
                                <label class="col-lg-4 control-label">New Category</label>
                                <div class="col-lg-8">
                                    <input type="text" name="category_name" class="form-control" placeholder="title" maxlength="255">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-lg-4 control-label">Tag</label>
                                <div class="col-lg-8">
                                    <input type="text" name="category_tag" class="form-control" placeholder="tag" maxlength="255">
                                </div>
                            </div>
                			...
                			<div class="form-group">
                                ...
                                <div class="col-lg-8">
                                <span class="group-ico icon-box"><i class="fa fa-address-book"></i> </span>
                                	<input type="hidden" name="category_icon" value="fa fa-address-book" class="category_icon" maxlength="255">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="color" id="favcolor" name="category_color" value="#1f88b5">
                                </div>
                            </div>
