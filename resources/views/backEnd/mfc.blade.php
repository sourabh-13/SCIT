                                ...
                                <div class="btn-group">
                                    <a href="mfc/add">
                                        <button id="editable-sample_new" class="btn btn-primary">
                                            Add MFC Record <i class="fa fa-plus"></i>
                                        </button>
                                    </a>    
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div id="editable-sample_length" class="dataTables_length">
                                        <form method='post' action="{{ url('admin/mfc-records') }}" id="records_per_page_form">
                                            <label>
                                ...
                                <div class="col-lg-6">
                                    <form method='get' action="{{ url('admin/mfc-records') }}">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="">
                                            ...
                                            <td>{{ $status }}</td>
                                            <td class="action-icn">
                                                <a href="{{ url('admin/mfc/edit/'.$value->id) }}" class="edit"><i data-toggle="tooltip" title="Edit!" class="fa fa-edit"></i></a>

                                                <a href="{{ url('admin/mfc/delete/'.$value->id) }}" class="delete"><i data-toggle="tooltip" title="Delete!" class="fa fa-trash-o"></i></a>
                                            </td>
                                        </tr>
                                        <?php } } ?>
                                    </tbody>
