                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 event-list-block">
                        ...
                        <div class="earnAreaScroller">
                            <ul class="event-list">
                                ...
                                <li class="daily-record-list">{{ $labels['daily_record']['label'] }}<span class="close-event {{ $daily_clas }}"><i class="{{ $daily_icon }}"></i></span></li><!--  today_daily_record -->
                                <li class="living-skill-list">{{ $labels['living_skill']['label'] }}<span class="close-event {{ $liv_clas }}"><i class="{{ $liv_icon }}"></i></span></li> <!-- today_skill_record -->
                                <li class="education-record-list">{{ $labels['education_record']['label'] }}<span class="close-event {{ $edu_clas }}"><i class="{{ $edu_icon }}"></i></span></li> <!-- today_education_record -->
                                <li class="mfc">{{ $labels['mfc']['label'] }}<span class="close-event {{ $mfc_clas }}"><i class="{{ $mfc_icon }}"></i></span></li>
                                <!-- today_mfc_record -->
