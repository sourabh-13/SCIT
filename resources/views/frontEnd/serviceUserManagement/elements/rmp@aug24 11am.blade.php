            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="add-new-box risk-tabs custm-tabs">
                            ...
                            <div class="col-md-11 col-sm-11 col-xs-12">
                                <div class="select-style title-name">
                                    <select disabled="disabled">
                                        <option>{{ $labels['rmp']['label'] }}<!--  Risk Management Plan  --></option>
                                    </select>
                                </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <h3 class="m-t-0 m-b-20 clr-blue rmp-details"> RMP Details </h3>
                        </div>
                        <form method="post" action="" id="rmp_form">
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xs-12 p-0 add-rcrd">
                                    ...
                                    <div class="col-md-11 col-sm-11 col-xs-12 r-p-0">
                                        <div class="input-group popovr">
                                            <input name="rmp_title_name" value="" type="text" class="form-control" id="rmp_title" maxlength="255"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="dynamic-rmp-form-fields">
                                {!! $form_pattern['su_rmp'] !!}
                            </div>
                            <!-- </div> -->   
                            ...
                            <div class="modal-footer m-t-0 m-b-15 modal-bttm">
                                ...
                                <button class="btn btn-warning sbt_rmp_btn" type="submit"> Confirm </button>
                            </div>
                        </form>
                    </div>
