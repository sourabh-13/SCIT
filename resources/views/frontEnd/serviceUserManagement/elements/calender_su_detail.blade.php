    ...
    $(document).ready(function(){
        ...
        $('.edit-evnt-sub-btn').click(function(){
            ...
            if($('.edit_cal_event').hasClass('active')) {
                ...
                details    = $('.calendar-event-details .edit_detail').val().trim();
                ...
                if(details == ''){
                    $('.calendar-event-details .edit_detail').addClass('red_border');
                    return false;
                } else{
                    $('.calendar-event-details .edit_detail').removeClass('red_border');                    
                }
                return true;
            }else{
                return false;
