            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-md-12 col-sm-12 col-xs-12 serch-btns text-right">
                        ...
                        <button class="btn label-default logged-btn active logged-incident-btn" type="button"> Logged Plans </button>
                    ...
                    <div class="add-new-box risk-tabs custm-tabs">
                        ...
                        <form method="post" action="" id="incident_form">
                            ...
                            <div class="modal-footer m-t-0 m-b-15 modal-bttm">
                                ...
                                <button class="btn btn-warning sbt-incident-btn" type="submit"> Confirm </button>
                            </div>
                        </form>
                    </div>
