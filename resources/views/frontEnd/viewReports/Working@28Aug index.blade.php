                ...
                <div class="col-md-6 col-sm-4 col-xs-12 p-0">
                    <div class="form-group col-md-12 col-sm-12 col-xs-12 p-0 metro-design">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            ?>
                            <input name="from_date" required class="form-control change_date trans" type="text" autocomplete="off" maxlength="10" readonly="" id="datetime-picker" value="{{ $from_date ? $from_date : '' }}" />
                        </div>
                    ...
                    <div class="panel-body">
                        <div class="top-stats-panel">
                            ...
                            <ul class="gauge-meta clearfix">
                                <li id="gauge-textfield" class="pull-left gauge-value">{{ $count['expenditure'] ? $count['expenditure'] : '0'}}</li>
                                <li class="pull-right gauge-title">{{ $count['cash_withdraw'] ? $count['cash_withdraw'] : '0'}}</li>
                            </ul>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="top-stats-panel">
                            ...
                            <div class="star-big text-center">
                                <div class="star-biginner">
                                    ...
                                    <span class="star-bigno" style="margin-left:40px">{{ $count['star'] ? $count['star'] : '0' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="chartJS">
                            <canvas id="line-chart-js" height="220" width="400" ></canvas>
                        </div>
                    </div>
                </section>  
            </div>
