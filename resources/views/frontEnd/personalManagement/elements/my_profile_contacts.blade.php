<div id="my_profile_contacts" class="tab-pane">
    <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="prf-contacts">
                ...
                <div class="location-info current_location"><p>{!! $manager_profile->current_location !!}</p></div>
                ...
                <div class="location-info">
                    <p><strong style="color:#3399CC;">Phone</strong> :  {!! $manager_profile->phone_no !!}<br>
                        <br>
                        <strong style="color:#3399CC;">Email</strong> : {!! $manager_profile->email !!}<br>
                        <br>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                <form method="post" action="" enctype="multipart/form-data" id='staff_edit_location_info'>
...
<div class="modal fade" id="" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">         
            <form method="post" action="" id='edit_contact_info'>
