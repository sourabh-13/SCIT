                        ...
                        <div class="risk-add-box risk-tabs">
                            <div class="form-group col-md-12 col-sm-12 col-xs-12 p-0 add-rcrd">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12 p-l-0">
                                    ...
                                    Enter a title,choose an icon and click plus to add
                                </div>
                            ...
                            <div class="form-group col-md-12 col-sm-12 col-xs-12 p-0 add-rcrd">
                                ...
                                <form id="custom-created-fields-form">
                                    ...
                                    <div class="modal-space created-fields">
                        ...
                        <div class="risk-search-box risk-tabs">
                            <form method="post" id="plan_search_form">
                                <div class="form-group col-md-12 col-sm-12 col-xs-12 p-0 add-rcrd">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12 p-l-0 m-b-15">
                                        <input type="text" name="search" class="form-control">
                                    </div>
                                    <div class="searched-plan" style="padding-top:10px">
...
<!--                                 <div class="col-md-1 col-sm-1 col-xs-1 p-0">
                            ...
                            <div class="form-group col-md-12 col-sm-12 col-xs-12 p-0 add-rcrd">
                                ...
                                <div class="modal-space e-created-fields">
        ...
        $.ajax({
            ...
            success:function(resp){
                ...
                if(resp == 'true'){
                    ...
                    $('span.popup_success_txt').text(' Plan Added Successsfully');
                    $('.popup_success').show();
        ...
        $.ajax({
            ...
            success:function(resp){
                ...
                if(resp == 'empty'){
                    ...
                    //show success message
                    $('span.popup_success_txt').text('Plan updated Successsfully');
                    $('.popup_success').show();
                    setTimeout(function(){$(".popup_success").fadeOut()}, 5000);
                }
                $('.loader').hide();
            ...
            $.ajax({
                ...
                success : function(resp){
                    ...
                    if(resp == 1){
                        ...
                        $('span.popup_success_txt').text('Plan Deleted Successsfully');
                        $('.popup_success').show();
                        setTimeout(function(){$(".popup_success").fadeOut()}, 5000);
                        $(this).closest('.cog-panel').siblings('.cog-panel').find('.pop-notifbox').removeClass('active');
                    }
