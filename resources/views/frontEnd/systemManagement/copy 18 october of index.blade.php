                ...
                <section class="panel">
                    ...
                    <div class="panel-body cus-panelbody">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6 daily-record" >
                            <div class="sys-mngmnt-box ">
                                <div class="sys-mngmnticon"> <i class="{{ $labels['daily_record']['icon'] }}"></i> </div>
                                 <!-- data-toggle="modal" href="#dailyrecordModal" -->
                                <p>{{ $labels['daily_record']['label'] }}</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-6 living-skill" >
                            <div class="sys-mngmnt-box ">
                                <div class="sys-mngmnticon"> <i class="{{ $labels['living_skill']['icon'] }}"></i> </div>
                                 <!-- data-toggle="modal" href="#dailyrecordModal" -->
                                <p>{{ $labels['living_skill']['label'] }}</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-6 education-record" >
                            <div class="sys-mngmnt-box ">
                                <div class="sys-mngmnticon"> <i class="{{ $labels['education_record']['icon'] }}"></i> </div>
                                 <!-- data-toggle="modal" href="#dailyrecordModal" -->
                                <p>{{ $labels['education_record']['label'] }}</p>
                            </div>
                        </div>
